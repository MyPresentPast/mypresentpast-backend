...
-- 1. USUARIOS
INSERT INTO users (name, password, type, avatar) VALUES ('mferradans', 'password123', 'ADMIN', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=400');
INSERT INTO users (name, password, type, avatar) VALUES ('Museo Nacional Argentino', 'museo123', 'INSTITUTION', 'https://images.unsplash.com/photo-1566127992631-137a642a90f4?w=400');
INSERT INTO users (name, password, type, avatar) VALUES ('Historia Argentina', 'historia123', 'NORMAL', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400');

-- 2. UBICACIONES
INSERT INTO locations (address, latitude, longitude) VALUES ('Villa María, Córdoba, Argentina', -32.4075, -63.2406);
INSERT INTO locations (address, latitude, longitude) VALUES ('Plaza de Mayo, Buenos Aires, Argentina', -34.6082, -58.3716);
INSERT INTO locations (address, latitude, longitude) VALUES ('Teatro Colón, Buenos Aires, Argentina', -34.6010, -58.3835);
INSERT INTO locations (address, latitude, longitude) VALUES ('Mendoza, Argentina', -32.8895, -68.8458);
INSERT INTO locations (address, latitude, longitude) VALUES ('Villa General Belgrano, Córdoba, Argentina', -31.9785, -64.5431);
INSERT INTO locations (address, latitude, longitude) VALUES ('Ushuaia, Tierra del Fuego, Argentina', -54.8019, -68.3030);
INSERT INTO locations (address, latitude, longitude) VALUES ('Bariloche, Río Negro, Argentina', -41.1335, -71.3103);
INSERT INTO locations (address, latitude, longitude) VALUES ('Rosario, Santa Fe, Argentina', -32.9442, -60.6505);
INSERT INTO locations (address, latitude, longitude) VALUES ('Córdoba Capital, Argentina', -31.4201, -64.1888);
INSERT INTO locations (address, latitude, longitude) VALUES ('La Plata, Buenos Aires, Argentina', -34.9205, -57.9536);

...
-- 1. USUARIOS
INSERT INTO user_account (name, password, type, avatar) VALUES ('mferradans', 'password123', 'ADMIN', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=400');
INSERT INTO user_account (name, password, type, avatar) VALUES ('Museo Nacional Argentino', 'museo123', 'INSTITUTION', 'https://images.unsplash.com/photo-1566127992631-137a642a90f4?w=400');
INSERT INTO user_account (name, password, type, avatar) VALUES ('Historia Argentina', 'historia123', 'NORMAL', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400');

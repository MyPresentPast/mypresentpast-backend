...
INSERT INTO user_account (profile_username, email, password, role, avatar, name, last_name) VALUES ('mferradans', 'mateo@test.com', '$2a$10$wPpCaSsVWMND5AEtYqLKfuKdgZb2JyHGSQA/poP/9jbYosU59ShBW', 'ADMIN', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face', 'Mateo', 'Ferradans');
INSERT INTO user_account (profile_username, email, password, role, avatar, name, last_name) VALUES ('Museo Nacional Argentino','museo@test.com', '$2a$10$wPpCaSsVWMND5AEtYqLKfuKdgZb2JyHGSQA/poP/9jbYosU59ShBW', 'INSTITUTION', 'https://images.unsplash.com/photo-1651419366419-d587fdf057fb?w=400&h=400&fit=crop', 'Museo Nacional Argentino', null);
INSERT INTO user_account (profile_username, email, password, role, avatar, name, last_name) VALUES ('Historia Argentina', 'historia@test.com','$2a$10$wPpCaSsVWMND5AEtYqLKfuKdgZb2JyHGSQA/poP/9jbYosU59ShBW', 'NORMAL', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop&crop=face', 'Historia', 'Argentina');
INSERT INTO user_account (profile_username, email, password, role, avatar, name, last_name) VALUES ('Universidad Nacional', 'universidad@test.com', '$2a$10$wPpCaSsVWMND5AEtYqLKfuKdgZb2JyHGSQA/poP/9jbYosU59ShBW', 'INSTITUTION', 'https://images.unsplash.com/photo-1607237138185-eedd9c632b0b?w=400&h=400&fit=crop', 'Universidad Nacional de Córdoba', null);
INSERT INTO user_account (profile_username, email, password, role, avatar, name, last_name) VALUES ('usuario_normal', 'normal@test.com', '$2a$10$wPpCaSsVWMND5AEtYqLKfuKdgZb2JyHGSQA/poP/9jbYosU59ShBW', 'NORMAL', 'https://images.unsplash.com/photo-1539571696285-e7d0710b8999?w=400&h=400&fit=crop&crop=face', 'Juan', 'Pérez');
